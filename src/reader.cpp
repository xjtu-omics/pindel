...
void build_record_RP (const bam1_t * r1, void *data)
{
   ...
   if (!(r1_core->flag & BAM_FUNMAP || r1_core->flag & BAM_FMUNMAP)) { // both reads are mapped.
      if ((r1_core->tid != r1_core->mtid) || (int)cabs(r1_core->isize) > r1_core->l_qseq + 2 * data_for_bam->InsertSize) {
...
void build_record_RP_Discovery (const bam1_t * r1, void *data)
{
   ...
   if (!(r1_core->flag & BAM_FUNMAP || r1_core->flag & BAM_FMUNMAP)) { // both reads are mapped.
      ...
      //}
      if ((r1_core->tid != r1_core->mtid) ||(int)cabs(r1_core->isize) > 3 * data_for_bam->InsertSize + 1000 || ((bool)(r1_core->flag & BAM_FREVERSE) == (bool)(r1_core->flag & BAM_FMREVERSE))) { // different chr or same strand or insert is too large
